 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Picture implements ModelInterface, ArrayAccess
{
...
'lng' => 'getLng'    ];
     ...
     * Sets type
     *
     * @param int $type Tipo da imagem. Os tipos disponíveis podem ser obtidos acessando o endpoint ```Inspection - Get Types```. Obrigatório.
     *
     * @return $this
     */
     ...
     * Sets hash
     *
     * @param string $hash Hash do arquivo da imagem. Obrigatório.
     *
     * @return $this
     */
     ...
     * Sets bytes
     *
     * @param int $bytes Tamanho em bytes do arquivo da imagem. Obrigatório.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url URL da imagem, acessível publicamente. Obrigatório.
     *
     * @return $this
     */
     ...
     * Sets lat
     *
     * @param float $lat Latitude em que a imagem foi fotografada.
     *
     * @return $this
     */
     ...
     * Sets lng
     *
     * @param float $lng Longitude em que a imagem foi fotografada.
     *
     * @return $this
     */
